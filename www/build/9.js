...
var UserProfilePage = (function () {
    ...
    UserProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-user-profile',template:/*ion-inline-start:"C:\Users\xakhan271\Documents\GitHub\elms\src\pages\user-profile\user-profile.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>User Profile</ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button (click)="editProfile()">\n\n        <ion-icon name="create"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content style="width:100%;height:100%">\n\n    <div style="display:table;width:100%;height:40%;background-color:#039be5;text-align:center;">\n\n        <div style="display:table-cell;vertical-align:middle;">          \n\n              <img class="profilepic" [src]="user.photoUrl ? user.photoUrl : \'assets/imgs/defaults/user.jpg\'" #myImage (click)="presentImage(myImage)"/>\n\n              <ion-icon name="camera" (click)="changePicture()" style="color:white;position: relative;right: 30px;bottom: 5px;font-size: 1.5em;"></ion-icon>\n\n              <h2 style="color:white;text-align: center; position: relative; right: 5px;font-family: g_bold;">{{ user?.name }}</h2>          \n\n        </div>\n\n      </div>    \n\n  <ion-list>\n\n    <ion-item>\n\n      <ion-icon name="mail" style="color:rgb(238, 198, 22)" item-start></ion-icon>\n\n      <h2>Email</h2>\n\n      <p>{{ user?.email }}</p>          \n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-icon name="call" style="color:rgb(16, 160, 59)" item-start></ion-icon>\n\n      <h2>Mobile</h2>\n\n      <p>{{ user?.phoneNumber }}</p>          \n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-icon name="person" style="color:rgb(38, 113, 226)" item-start></ion-icon>\n\n      <h2>Manager</h2>\n\n      <p>{{ user?.manager?.name }}</p>          \n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-icon name="people" style="color:rgb(116, 75, 21)" item-start></ion-icon>\n\n      <h2>Team</h2>\n\n      <p>{{ user?.team?.name }}</p>          \n\n    </ion-item>\n\n  </ion-list>\n\n</ion-content>\n\n  '/*ion-inline-end:"C:\Users\xakhan271\Documents\GitHub\elms\src\pages\user-profile\user-profile.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* ToastController */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__providers_image_service_image_service__["a" /* ImageProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_image_service_image_service__["a" /* ImageProvider */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__providers_app_context_app_context__["a" /* AppContextProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_app_context_app_context__["a" /* AppContextProvider */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["a" /* ImageViewerController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["a" /* ImageViewerController */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */]) === "function" && _g || Object])
    ], UserProfilePage);
